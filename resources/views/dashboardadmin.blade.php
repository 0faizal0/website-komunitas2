                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="images/icon/logo.png" alt="MGO" />
                        </a>
                        ...
                        <table cellspacing="0" cellpadding="0" class="darkTable" style="margin-left:auto;margin-right:auto;">
                            ...
                            <tr style="background-color: #ffffff; color:Gray;">
                               ...
                               <?php } ?>
                                ...
                                <td>
                                <a href="{{ url('view/'.$member->id) }}" class="badge badge-pill btn-success px3 py-2">View</a>
                                    <a href="{{ url('role-edit/'.$member->id)}}" class="badge badge-pill btn-primary px3 py-2">Edit</a>
                                    <a href={{ "delete/".$member['id'] }} class="badge badge-pill btn-danger px3 py-2">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
